...
#
SDK_DIR = "C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A"
OPENSSL_DIR = D:\install\openssl-1.2

# COMPILER_MODE specifies how you want the libaries compiled:

# /MD /O2 /D NDEBUG : 生成release版本库
# /MDd ： 生成Debug版本库
COMPILER_MODE = /MDd
...
# /RTC1 /RTCs
OTHER_FLAGS = /c /nologo /EHsc  /W2 /MD /O2 /D NDEBUG
...
# $(WIN32_OBJS)
LIB_OBJS = $(AFF_OBJS) $(LZMA_OBJS)   $(ZLIB_OBJS)
