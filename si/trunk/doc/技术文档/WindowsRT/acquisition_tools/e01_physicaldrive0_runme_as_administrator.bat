...
set examiner="Data Acquisition Specialist's Name"
set notes_physicaldrive="Acquisition of Physical Drive 0 on Microsoft Surface RT"
set output_prefix=WindowsPhysicalDrive0
set device=\\.\\PhysicalDrive0
...
%dd% if=%device% | %e01maker% name=%ipath%%output_prefix% type=disk --fast case_number=%case_number% evidence_number=%evidence_number% unique_description=%unique_description% examiner=%examiner% notes=%notes_physicaldrive%
