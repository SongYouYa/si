#ifndef SIBROWSER_BROWSERINFORMATION_H
#define SIBROWSER_BROWSERINFORMATION_H
#include <string>
#include <vector>
#include "common.h"
...
typedef std::vector<BrowserHistory> BrowserHistorys;
...
typedef std::vector<BrowserDownload> BrowserDownloads;
...
#endif // SIBROWSER_BROWSERINFORMATION_H
