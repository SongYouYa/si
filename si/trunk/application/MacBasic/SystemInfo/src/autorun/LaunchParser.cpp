...
namespace macbasic {
    ...
    bool CLaunchParser::ParseLauchDaemon(PSIHANDLE plistHandle, AutoRunInfo& lauchDaemonInfo)
    {
    ...
    void CLaunchParser::NoteBool(std::string keyName, bool bValue, std::wstring& note)
    {
    ...
    void CLaunchParser::NoteStr(std::string keyName, std::string strValue, std::wstring& note)
    {
       std::wstring wName = CPCodeChanger::UTF8ToUnicode(keyName.c_str());
       std::wstring wValue = CPCodeChanger::UTF8ToUnicode(strValue.c_str());
       note.append(wName + L":" + wValue + L"; ");
    }
    void CLaunchParser::NoteInt(std::string keyName, int64 intv, std::wstring& note)
    {
        std::wstring wName = CPCodeChanger::UTF8ToUnicode(keyName.c_str());
       std::wstring wstrv = boost::lexical_cast<std::wstring>(intv);
       note.append(wName + L":" + wstrv + L"; ");
    }
     bool CLaunchParser::IsTypeString(boost::any& value)
     {
         try{
     ...
     bool CLaunchParser::IsTypeArray(boost::any& value)
     {
         try{
     ...
     bool CLaunchParser::IsTypeBool(boost::any& value)
     {
         try{
     ...
     bool CLaunchParser::IsTypeDict(boost::any& value)
     {
         try{
