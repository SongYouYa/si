...
SkypeAnalyzer::SkypeAnalyzer()
    : m_pDB(NULL)
{
}

bool SkypeAnalyzer::GetSkypeUserInfomation(const std::wstring &wstrDBName, std::vector<SkypeUserRecord> & vecUserRecords)
{
    if (wstrDBName.empty()) {
        return false;
    }
...
bool SkypeAnalyzer::GetSkypeContactInformation(const std::wstring &wstrDBName, std::vector<SkypeContactRecord> & vecContactRecords)
{
    if (wstrDBName.empty()) {
        return false;
    }
...
bool SkypeAnalyzer::GetSkypeMSgInformation(const std::wstring & wstrDBName, std::vector<SkypeMsgRecord> & vecMsgRecords)
{
    if (wstrDBName.empty()) {
        return false;
    }
...
bool SkypeAnalyzer::GetChatMsgInformation(std::vector<SkypeMsgRecord> & vecMsgRecords)
{
    int result;
    char* errmsg = NULL;
    char** dbResult;
...
bool SkypeAnalyzer::GetCallMsgInformation(std::vector<SkypeMsgRecord> & vecMsgRecords)
{
    int result;
    char* errmsg = NULL;
    char** dbResult;
...
bool SkypeAnalyzer::GetTransferMsgInfortion(std::vector<SkypeMsgRecord> & vecMsgRecords)
{
    int result;
    char* errmsg = NULL;
    char** dbResult;
...
bool SkypeAnalyzer::AnalyzerContent(std::string &strContent, std::wstring &wstrMsg)
{
    try {
        QString strText;
...
std::wstring SkypeAnalyzer::GetUserGender(const std::wstring &strCode)
{
...
void SkypeAnalyzer::GetAccountInfo()
{
    int result;
    char* errmsg = NULL;
    char** dbResult;
...
void SkypeAnalyzer::LToTime(long ltime, CPTime & time)
{
    time_t ttTime = ltime;
    time = CPTime::UTC2LocalTime(ttTime, siutility::MacCommonHelper::GetTimezoneRegion());
    return;
}
}
